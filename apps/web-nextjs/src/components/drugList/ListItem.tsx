...
export type ListItemProps = {
  drug: InfiniteDrugApiResponse["data"][number];
  isFirst?: boolean;
};
export const ListItem = ({ drug, isFirst }: ListItemProps) => {
        ...
        <div className='flex max-w-60 justify-start truncate font-bold text-green-600 dark:text-green-400'>
          <p
            ...
            {drug.generic?.slug ? (
              <>
                <Link
                  data-testid='drug-card-genericName'
        ...
        <div className='flex justify-start font-bold text-blue-600 dark:text-blue-400'>
          <p
            ...
            {drug.agent?.slug ? (
              <>
                <Link
                  data-testid='drug-card-agentName'
        ...
        <div className='flex justify-start font-bold text-orange-600 dark:text-orange-400'>
          <p
            ...
            {drug.company_name && drug.company?.slug ? (
              <>
                <Link
                  data-testid='drug-card-companyName'
