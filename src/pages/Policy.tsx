const Policy = () => {
  return (
    <main className='prose prose-lg dark:prose-invert container mx-auto max-w-4xl px-4 py-8'>
      ...
      <ul className='mb-6 list-disc space-y-4 pl-6'>
        ...
        <li>
          <p className='mb-8 text-sm text-gray-600 dark:text-gray-400'>
            ...
            &quot;Our&quot; in this Agreement) refers to Sudan Codex.
          </p>
        </li>
        <li>
          <p className='mb-8 text-sm text-gray-600 dark:text-gray-400'>
        ...
        <li>
          <p className='mb-8 text-sm text-gray-600 dark:text-gray-400'>
            <strong className='font-medium'>Country</strong> refers to: Sudan
          </p>
        </li>
        <li>
          <p className='mb-8 text-sm text-gray-600 dark:text-gray-400'>
        ...
        <li>
          <p className='mb-8 text-sm text-gray-600 dark:text-gray-400'>
            <strong className='font-medium'>Service Provider</strong> means any
        ...
        <li>
          <p className='mb-8 text-sm text-gray-600 dark:text-gray-400'>
            <strong className='font-medium'>Website</strong> refers to Sudan
            Codex, accessible from{" "}
            <a
              href='https://sudan-codex.firebaseapp.com'
              rel='external nofollow noopener'
              target='_blank'>
              https://sudan-codex.firebaseapp.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul className='mb-6 list-disc space-y-4 pl-6'>
        <li>
          <strong className='font-medium'>Cookies or Browser Cookies.</strong> A
        ...
        <li>
          <strong className='font-medium'>Web Beacons.</strong> Certain sections
